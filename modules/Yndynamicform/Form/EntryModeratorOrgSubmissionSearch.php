 ...
 * Time: 2:40 PM
 */
class Yndynamicform_Form_EntryModeratorOrgSubmissionSearch extends Engine_Form
{
...
//        $this -> addElement($start);
        ...
        $start->setLabel("Submission date (From)");
//        $start->setAttribs(array('placeholder' => $view->translate('Submission date (From)')));
...
//        $start->addValidator($date_validate);
        ...
        $end = new Engine_Form_Element_CalendarDateTime('to_date');
        $end->setLabel("Submission date (To)");
//        $end->setAttribs(array('placeholder' => $view->translate('Submission date (From)')));
...
//        $this -> addElement($end);
        ...
        $this->addElement('dummy', 'conditional_logic_tpl', array(
            'decorators' => array( array(
                'ViewScript',
                array(
                    'viewScript' => '_advanced_search_org_submission.tpl',
                    'class' => 'form_element',
                )
            )),
        ));
